...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            聯絡方式：<asp:RadioButtonList ID="rbl_Phone" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rbl_Phone_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatLayout="Flow">
